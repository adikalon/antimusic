...
$args = array(
	...
	'meta_query' => array(
		array(
			'key' => 'country_id',
			'value' => urldecode($wp_query->query_vars['country'])
		)
	),
	'meta_key' => 'year',
...
<div class="ui segment">
	<div class="ui breadcrumb">
		...
		<a class="section" href="<?php echo get_permalink('/'); ?>/countries/"><?php wp_title(''); ?></a>
		<div class="divider"> / </div>
		<h2 class="active section category-header"><?php echo get_post_meta(get_posts(array('numberposts' => 1, 'meta_value' => urldecode($wp_query->query_vars['country'])))[0]->ID, 'country', true); ?></h2>
	</div>
